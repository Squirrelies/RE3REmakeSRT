    ...
    public static class Program
    {
        ...
        public static void GenerateClipping()
        {
            ...
            WeaponToImageTranslation = new Dictionary<Weapon, System.Drawing.Rectangle>()
            {
                ...
                { new Weapon() { WeaponID = WeaponEnumeration.Lightning_Hawk, Attachments = AttachmentsFlag.First }, new System.Drawing.Rectangle(Program.INV_SLOT_WIDTH * ++weaponColumnInc, Program.INV_SLOT_HEIGHT * weaponRowInc, Program.INV_SLOT_WIDTH * 2, Program.INV_SLOT_HEIGHT) },
